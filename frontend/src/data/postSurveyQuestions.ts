...
export const POST_SURVEY_QUESTIONS: SurveyQuestion[] = [
  { id: "conversation_naturalness", question: "The conversation felt natural and human-like.", options: LIKERT_AGREE },
  { id: "voice_naturalness", question: "The voice itself sounded natural and human-like.", options: LIKERT_AGREE },
  ...
  { id: "negative_emotional_expressiveness", question: "The voice was able to express negative emotion (anger, frustration, etc.) during the conversation when pushed.", options: LIKERT_AGREE_OPTIONAL },
